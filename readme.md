...
- Thành viên trong nhóm:
  ...
  | --: | :-- | :-- | :-- |
  | 1 | Vũ Đức Anh | 20225257 | Thiết kế Core Game Logic, quản lý vòng lặp RTOS và thuật toán va chạm vật lý (app.cpp). |
  | 2 | Vũ Thùy Dương | 20235315 | Thiết kế giao diện UI/UX trên TouchGFX, xử lý đồ họa và quản lý chuyển màn (GameScreenView). |
